...
func init() {
	proto.RegisterType((*OpenReq)(nil), "buffs.OpenReq")
	proto.RegisterType((*OpenRes)(nil), "buffs.OpenRes")
	proto.RegisterType((*CloseReq)(nil), "buffs.CloseReq")
	proto.RegisterType((*CloseRes)(nil), "buffs.CloseRes")
...
var fileDescriptor_490983b71ca20843 = []byte{
	...
	,
}
...
func (c *recvClient) Open(ctx context.Context, in *OpenReq, opts ...grpc.CallOption) (*OpenRes, error) {
	out := new(OpenRes)
	err := c.cc.Invoke(ctx, "/buffs.Recv/Open", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *recvClient) Close(ctx context.Context, in *CloseReq, opts ...grpc.CallOption) (*CloseRes, error) {
	out := new(CloseRes)
	err := c.cc.Invoke(ctx, "/buffs.Recv/Close", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *recvClient) Attach(ctx context.Context, in *AttachReq, opts ...grpc.CallOption) (Recv_AttachClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Recv_serviceDesc.Streams[0], "/buffs.Recv/Attach", opts...)
	if err != nil {
		return nil, err
	}
